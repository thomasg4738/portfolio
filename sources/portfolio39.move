module portfolio::portfolio39;

use portfolio::asset::{Asset, new_asset};
use sui::coin::{TreasuryCap, CoinMetadata, create_currency, Coin, mint, burn};
use sui::url::Url;

public struct Portfolio39<phantom T, phantom C0, phantom C1, phantom C2, phantom C3, phantom C4, phantom C5, phantom C6, phantom C7, phantom C8, phantom C9, phantom C10, phantom C11, phantom C12, phantom C13, phantom C14, phantom C15, phantom C16, phantom C17, phantom C18, phantom C19, phantom C20, phantom C21, phantom C22, phantom C23, phantom C24, phantom C25, phantom C26, phantom C27, phantom C28, phantom C29, phantom C30, phantom C31, phantom C32, phantom C33, phantom C34, phantom C35, phantom C36, phantom C37, phantom C38> has key, store {
    id: UID,
...
public fun create_portfolio39<T: drop, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C22, C23, C24, C25, C26, C27, C28, C29, C30, C31, C32, C33, C34, C35, C36, C37, C38>(
    witness: T,
    amount0: u64,
    amount1: u64,
    amount2: u64,
    ...
    icon_url: Option<Url>,
    ctx: &mut TxContext,
): (Portfolio39<T, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C22, C23, C24, C25, C26, C27, C28, C29, C30, C31, C32, C33, C34, C35, C36, C37, C38>, CoinMetadata<T>) {
...
public fun mint_portfolio39<T: drop, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C22, C23, C24, C25, C26, C27, C28, C29, C30, C31, C32, C33, C34, C35, C36, C37, C38>(
    input_coin0: Coin<C0>,
    input_coin1: Coin<C1>,
    input_coin2: Coin<C2>,
    input_coin3: Coin<C3>,
    ...
    portfolio: &mut Portfolio39<T, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C22, C23, C24, C25, C26, C27, C28, C29, C30, C31, C32, C33, C34, C35, C36, C37, C38>,
    amount: u64,
    ctx: &mut TxContext,
): Coin<T> {
