...
public fun create_portfolio64<T: drop, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C22, C23, C24, C25, C26, C27, C28, C29, C30, C31, C32, C33, C34, C35, C36, C37, C38, C39, C40, C41, C42, C43, C44, C45, C46, C47, C48, C49, C50, C51, C52, C53, C54, C55, C56, C57, C58, C59, C60, C61, C62, C63>(
    witness: T,
    amount0: u64,
    amount1: u64,
    amount2: u64,
    ...
    icon_url: Option<Url>,
    ctx: &mut TxContext,
): (Portfolio64<T, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C22, C23, C24, C25, C26, C27, C28, C29, C30, C31, C32, C33, C34, C35, C36, C37, C38, C39, C40, C41, C42, C43, C44, C45, C46, C47, C48, C49, C50, C51, C52, C53, C54, C55, C56, C57, C58, C59, C60, C61, C62, C63>, CoinMetadata<T>) {
    ...
    (
        Portfolio64 {
            ...
            asset59: new_asset<C59>(amount59),
            asset60: new_asset<C60>(amount60),
            asset61: new_asset<C61>(amount61),
            asset62: new_asset<C62>(amount62),
            asset63: new_asset<C63>(amount63),
        },
        c,
    )
}

public fun mint_portfolio64<T: drop, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C22, C23, C24, C25, C26, C27, C28, C29, C30, C31, C32, C33, C34, C35, C36, C37, C38, C39, C40, C41, C42, C43, C44, C45, C46, C47, C48, C49, C50, C51, C52, C53, C54, C55, C56, C57, C58, C59, C60, C61, C62, C63>(
    input_coin0: Coin<C0>,
    input_coin1: Coin<C1>,
    input_coin2: Coin<C2>,
    input_coin3: Coin<C3>,
    ...
    input_coin59: Coin<C59>,
    input_coin60: Coin<C60>,
    input_coin61: Coin<C61>,
    input_coin62: Coin<C62>,
    input_coin63: Coin<C63>,
    portfolio: &mut Portfolio64<T, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C22, C23, C24, C25, C26, C27, C28, C29, C30, C31, C32, C33, C34, C35, C36, C37, C38, C39, C40, C41, C42, C43, C44, C45, C46, C47, C48, C49, C50, C51, C52, C53, C54, C55, C56, C57, C58, C59, C60, C61, C62, C63>,
    amount: u64,
    ctx: &mut TxContext,
): Coin<T> {
    ...
    portfolio.asset59.deposit(input_coin59, amount);
    portfolio.asset60.deposit(input_coin60, amount);
    portfolio.asset61.deposit(input_coin61, amount);
    portfolio.asset62.deposit(input_coin62, amount);
    portfolio.asset63.deposit(input_coin63, amount);

    mint(&mut portfolio.treasury_cap, amount, ctx)
}

public fun burn_portfolio64<T: drop, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C22, C23, C24, C25, C26, C27, C28, C29, C30, C31, C32, C33, C34, C35, C36, C37, C38, C39, C40, C41, C42, C43, C44, C45, C46, C47, C48, C49, C50, C51, C52, C53, C54, C55, C56, C57, C58, C59, C60, C61, C62, C63>(
    portfolio_coin: Coin<T>,
    portfolio: &mut Portfolio64<T, C0, C1, C2, C3, C4, C5, C6, C7, C8, C9, C10, C11, C12, C13, C14, C15, C16, C17, C18, C19, C20, C21, C22, C23, C24, C25, C26, C27, C28, C29, C30, C31, C32, C33, C34, C35, C36, C37, C38, C39, C40, C41, C42, C43, C44, C45, C46, C47, C48, C49, C50, C51, C52, C53, C54, C55, C56, C57, C58, C59, C60, C61, C62, C63>,
    ctx: &mut TxContext,
): (Coin<C0>, Coin<C1>, Coin<C2>, Coin<C3>, Coin<C4>, Coin<C5>, Coin<C6>, Coin<C7>, Coin<C8>, Coin<C9>, Coin<C10>, Coin<C11>, Coin<C12>, Coin<C13>, Coin<C14>, Coin<C15>, Coin<C16>, Coin<C17>, Coin<C18>, Coin<C19>, Coin<C20>, Coin<C21>, Coin<C22>, Coin<C23>, Coin<C24>, Coin<C25>, Coin<C26>, Coin<C27>, Coin<C28>, Coin<C29>, Coin<C30>, Coin<C31>, Coin<C32>, Coin<C33>, Coin<C34>, Coin<C35>, Coin<C36>, Coin<C37>, Coin<C38>, Coin<C39>, Coin<C40>, Coin<C41>, Coin<C42>, Coin<C43>, Coin<C44>, Coin<C45>, Coin<C46>, Coin<C47>, Coin<C48>, Coin<C49>, Coin<C50>, Coin<C51>, Coin<C52>, Coin<C53>, Coin<C54>, Coin<C55>, Coin<C56>, Coin<C57>, Coin<C58>, Coin<C59>, Coin<C60>, Coin<C61>, Coin<C62>, Coin<C63>) {
    ...
    (
        ...
        portfolio.asset59.withdraw(amount, ctx),
        portfolio.asset60.withdraw(amount, ctx),
        portfolio.asset61.withdraw(amount, ctx),
        portfolio.asset62.withdraw(amount, ctx),
        portfolio.asset63.withdraw(amount, ctx),
    )
}
